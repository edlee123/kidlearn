...
class HierarchicalSSBG(object):
    ...
    def CreateHSSBG(self, seq_graph):
        ...
        self.ncompetencies = mainSSBG.ncompetencies
        self.SSBGs = {}
...
class SSBanditGroup(object):
    ...
    def instanciate_ssb(self, ii, is_hierarchical):
        return SSbandit(ii, len(self.RT[ii]), self.ncompetencies, is_hierarchical, param_values=self.param_values[ii], params=self.params)
