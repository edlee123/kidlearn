...
​
    graph.kGraph.draw_curve([mean_data], labels = [xp._groups.keys()], nb_ex = len(data), typeData = "skill_level", type_data_spe = skill_labels[k] ,ref = skill_labels[k], markers = None, colors = [["#00BBBB","green",'#FF0000',"black"]], line_type = ['dashed','dashdot','solid',"dotted"], legend_position = 3, std_data = [std_data])
​
